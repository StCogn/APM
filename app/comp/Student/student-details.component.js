...
var StudentDetailComponent = (function () {
    function StudentDetailComponent(_route, _router, _service) {
        this._route = _route;
    ...
    StudentDetailComponent.prototype.getStudent = function (id) {
        var _this = this;
        this._service.getStudent(id).subscribe(function (student) { return _this.student = student; }, function (error) { return _this.errorMesssage = error; });
    };
